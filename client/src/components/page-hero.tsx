...
export function PageHero({ icon: Icon, title, subtitle, actions, children }: PageHeroProps) {
  return (
    <div className="-mx-6 lg:-mx-8 -mt-6 lg:-mt-8 mb-6">
      <div
        className="relative overflow-hidden px-6 lg:px-8 py-8"
        style={{
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-4">
            <div className="h-12 w-12 rounded-xl flex items-center justify-center bg-white/15 border border-white/20 backdrop-blur-sm">
